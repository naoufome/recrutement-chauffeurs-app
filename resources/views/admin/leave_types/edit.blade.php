...
<div class="space-y-6">
    ...
    <!-- Formulaire -->
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl rounded-lg border border-blue-100 dark:border-blue-800">
        <form method="POST" action="{{ route('admin.leave-types.update', $leaveType->id) }}" class="p-6 space-y-6">
            @csrf
            @method('PUT')
            <div class="space-y-4"> {{-- Inner container --}}
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name', $leaveType->name) }}" required autofocus
                ...
                {{-- Description --}}
                 <div>
                    ...
                    <textarea name="description" id="description" rows="3"
                              class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:text-gray-300 sm:text-sm">{{ old('description', $leaveType->description) }}</textarea>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div>
                        ...
                        <select name="requires_approval" id="requires_approval" required
                                class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:text-gray-300 sm:text-sm">
                             <option value="1" @selected(old('requires_approval', $leaveType->requires_approval) == 1)>Oui</option>
                             <option value="0" @selected(old('requires_approval', $leaveType->requires_approval) == 0)>Non</option>
                        </select>
                     ...
                     <div>
                        ...
                        <select name="affects_balance" id="affects_balance" required
                                class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:text-gray-300 sm:text-sm">
                            <option value="1" @selected(old('affects_balance', $leaveType->affects_balance) == 1)>Oui</option>
                            <option value="0" @selected(old('affects_balance', $leaveType->affects_balance) == 0)>Non</option>
                        </select>
                     ...
                     <div>
                        ...
                        <select name="is_active" id="is_active" required
                                class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:text-gray-300 sm:text-sm">
                            <option value="1" @selected(old('is_active', $leaveType->is_active) == 1)>Oui</option>
                            <option value="0" @selected(old('is_active', $leaveType->is_active) == 0)>Non</option>
                        </select>
                 ...
                 <div>
                    ...
                    <div class="flex items-center mt-1">
                        <input type="color" name="color_code" id="color_code" value="{{ old('color_code', $leaveType->color_code ?? '#3498DB') }}"
                        ...
                        <input type="text" id="color_code_text" value="{{ old('color_code', $leaveType->color_code ?? '#3498DB') }}" maxlength="7" pattern="^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$"
